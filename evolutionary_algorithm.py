...
class MOEA:
    ...
    # Task 27: Local search for KP (constructing knapsack random, current function is a basic local search function. Later would improve to simulate annealing function)
